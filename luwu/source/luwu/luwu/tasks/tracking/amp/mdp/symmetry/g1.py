...
def _transform_policy_obs_left_right(
    ...
    for h in range(HISTORY_LEN):
        ...
        obs[:, start_idx:end_idx] = _switch_g1_29dof_joints_left_right(
    ...
    for h in range(HISTORY_LEN):
        ...
        obs[:, start_idx:end_idx] = _switch_g1_29dof_key_body_pos_left_right(
            obs[:, start_idx:end_idx]
        )
...
def _switch_g1_29dof_key_body_pos_left_right(
