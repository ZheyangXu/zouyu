...
from luwu.assets.unitree import UNITREE_G1_29DOF_CFG as ROBOT_CFG
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        joint_vel = ObsTerm(
            func=mdp.joint_vel_rel, scale=0.05, noise=Unoise(n_min=-2.0, n_max=2.0)
        )  # 1.5
        ...
        def __post_init__(self):
            ...
            self.concatenate_terms = (
                True  # Concatenate observation terms (default True)
            )
