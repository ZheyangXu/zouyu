...
from luwu.assets.unitree import UNITREE_GO2_CFG as ROBOT_CFG
...
@configclass
class Go2RobotEnvCfg(ManagerBasedRLEnvCfg):
...
@configclass
class Go2RobotPlayEnvCfg(Go2RobotEnvCfg):
    def __post_init__(self):
        super().__post_init__()
...
@configclass
class Go2RobotRoughEnvCfg(Go2RobotEnvCfg):
...
@configclass
class Go2RobotRoughPlayEnvCfg(Go2RobotRoughEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
