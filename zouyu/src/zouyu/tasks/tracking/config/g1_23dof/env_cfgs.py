...
from zouyu.assets.robots.unitree_g1.g1_23dof_constants import (
    G1_23DOF_ACTION_SCALE,
    get_g1_23dof_robot_cfg,
)
from zouyu.tasks.tracking.tracking_env_cfg import make_tracking_env_cfg


def zouyu_g1_23dof_flat_tracking_env_cfg(
