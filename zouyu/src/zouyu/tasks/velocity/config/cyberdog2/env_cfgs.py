...
from zouyu.assets.robots import get_cyberdog2_robot_cfg
from zouyu.tasks.velocity.velocity_env_cfg import make_velocity_env_cfg

TerrainType = Literal["rough", "obstacles"]


def zouyu_cyberdog2_rough_env_cfg(
    play: bool = False,
) -> ManagerBasedRlEnvCfg:
    """Create Unitree Cyberdog2 rough terrain velocity configuration."""
    cfg = make_velocity_env_cfg()

    cfg.sim.mujoco.ccd_iterations = 500
    cfg.sim.contact_sensor_maxmatch = 500

    cfg.scene.entities = {"robot": get_cyberdog2_robot_cfg()}

    # Set raycast sensor frame to Cyberdog2 base_link.
