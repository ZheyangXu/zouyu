...
import zouyu.task.velocity.mdp as zouyu_mdp
...
def make_velocity_env_cfg() -> ManagerBasedRlEnvCfg:
    ...
    critic_terms = {
        **actor_terms,
        ...
        "foot_height": ObservationTermCfg(
            func=zouyu_mdp.foot_height,
            params={
                "asset_cfg": SceneEntityCfg("robot", site_names=())
            },  # Set per-robot.
        ),
        "foot_air_time": ObservationTermCfg(
            func=zouyu_mdp.foot_air_time,
            params={"sensor_name": "feet_ground_contact"},
        ),
        "foot_contact": ObservationTermCfg(
            func=zouyu_mdp.foot_contact,
            params={"sensor_name": "feet_ground_contact"},
        ),
        "foot_contact_forces": ObservationTermCfg(
            func=zouyu_mdp.foot_contact_forces,
            params={"sensor_name": "feet_ground_contact"},
        ),
    }
    ...
    rewards = {
        ...
        "body_orientation_l2": RewardTermCfg(
            func=zouyu_mdp.body_orientation_l2,
            weight=-1.0,
            params={
        ...
        "pose": RewardTermCfg(
            func=zouyu_mdp.variable_posture,
            weight=1.0,
            params={
                "asset_cfg": SceneEntityCfg("robot", joint_names=".*"),
                "command_name": "twist",
